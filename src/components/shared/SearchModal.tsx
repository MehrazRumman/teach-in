              ...
              >
                <Dialog.Panel className="smooth-effect max-h-[80vh] w-[90vw] transform space-y-6 overflow-x-hidden overflow-y-scroll rounded-2xl bg-white p-6 text-left align-middle shadow-xl transition-all dark:bg-dark-background dark:shadow-white/5 md:w-[60vw] lg:w-[75vw]">
                  ...
                  <If condition={searchStatus === 'loading' && value !== ''}>
                    ...
                    <Else>
                      <div className="items-center justify-center bg-blue-50 dark:bg-blue-900">
                        {' '}
                        <div className="items-center justify-center rounded bg-blue-100 px-4 py-2 text-center dark:bg-blue-950">
                          Course:
                        </div>
                      ...
                      <div className="items-center justify-center bg-green-50 dark:bg-green-900">
                        {' '}
                        <div className="items-center justify-center rounded bg-green-100 px-4 py-2 text-center dark:bg-green-950">
                          Notes:
                        </div>
                      ...
                      <div className="items-center justify-center bg-purple-50 dark:bg-purple-900">
                        {' '}
                        <div className="items-center justify-center rounded bg-purple-100 px-4 py-2 text-center dark:bg-purple-950">
                          Model Test:
                        </div>
                        <ul className="space-y-4">
                          {datas?.tests &&
                      ...
                      <div className="items-center justify-center bg-red-50 dark:bg-red-900">
                        {' '}
                        <div className="items-center justify-center rounded bg-red-100 px-4 py-2 text-center dark:bg-red-950">
                          Article:
                        </div>
                        <ul className="space-y-4">
                          {datas?.articles &&
